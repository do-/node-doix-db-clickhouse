...
const {DbLang, DbColumn, DbType, DbTypeArithmeticInt, DbTypeCharacter, DbTypeDate, DbTypeTimestamp, DbTypeArithmeticFixed, DbTable, DbView, DbFunction, DbProcedure} = require ('doix-db')
